    ...
    bmak && bmak.hasOwnProperty('ver') && bmak.hasOwnProperty('sed')
        ...
        : {
              ...
              fas: function () {
                  try {
                      return (
                          ...
                          (Boolean(navigator.storeWebWideTrackingException) <<
                              20) +
              ...
              sed: function () {
                  ...
                  var o;
                  o =
                      void 0 !== window.XPathResult ||
                      void 0 !== document.XPathResult
                          ? '1'
                          : '0';
                  var m;
                  m =
              ...
              cma: function (event, a) {
                  try {
                      if (
                          ...
                          n = n + ';';
                          bmak.me_vel =
                              bmak.me_vel + bmak.me_cnt + a + file + sha + diff;
              ...
              x2: function () {
                  ...
                  var get_cf_date =
                      ...
                      fromCharCode(116) +
                      fromCharCode(101);
                  var bmak_get_cf_date = window[bmak][get_cf_date];
                  /** @type {number} */
                  var data = 0;
                  return (
                      'function' == typeof bmak_get_cf_date &&
                          (data = bmak_get_cf_date()),
                      data
                  );
              },
              np: function () {
              ...
              cal_dis: function (f) {
                  ...
                  var sxy = f[4] - f[5];
                  var value = Math.sqrt(
                      lightI * lightI + lightJ * lightJ + sxy * sxy
                  );
              ...
              hbs: function () {
                  try {
                      return (
                          ...
                          (Boolean(window.cdc_adoQpoasnfa76pfcZLmcfl_Array) <<
                              1) +
                          (Boolean(window.cdc_adoQpoasnfa76pfcZLmcfl_Promise) <<
                              2) +
              ...
              cka: function (event, number) {
                  try {
                      ...
                      if (
                          !(!bmak.js_post || 1 != number || (13 != n && 9 != n))
                      ) {
                          /** @type {number} */
                          bmak.aj_type = 3;
                          bmak.bpd();
              ...
              cdoa: function (canCreateDiscussions) {
                  try {
                      if (
                          ...
                          var hexString = bmak.getFloatVal(
                              canCreateDiscussions.gamma
                          );
                          var s =
                              bmak.doe_cnt +
                              ',' +
                  ...
                  try {
                      if (
                          ...
                          if (canCreateDiscussions.acceleration) {
                              e = bmak.getFloatVal(
                                  canCreateDiscussions.acceleration.x
                              );
                              n = bmak.getFloatVal(
                                  canCreateDiscussions.acceleration.y
                              );
                              o = bmak.getFloatVal(
                                  canCreateDiscussions.acceleration.z
                              );
                          }
                          /** @type {number} */
                          var m = -1;
                          ...
                          var i = -1;
                          if (
                              canCreateDiscussions.accelerationIncludingGravity
                          ) {
                              m = bmak.getFloatVal(
                                  canCreateDiscussions
                          ...
                          if (canCreateDiscussions.rotationRate) {
                              c = bmak.getFloatVal(
                                  canCreateDiscussions.rotationRate.alpha
                              );
                              b = bmak.getFloatVal(
                                  canCreateDiscussions.rotationRate.beta
                              );
                  ...
                  try {
                      if ((bmak.bpd(), 0 == bmak.sdfn.length)) {
                          if (
                              ...
                              void 0 !==
                                  document.getElementsByName('bm-telemetry'))
                          ) {
                              var PL$13 =
                                  document.getElementsByName('bm-telemetry');
                              /** @type {number} */
              ...
              getdurl: function () {
                  return bmak.enReadDocUrl
                      ? document.URL.replace(/\\|"/g, '')
                      : '';
              },
              x1: function () {
                  return Math.floor(16777216 * (1 + Math.random())).toString(
                      36
                  );
              },
              gck: function () {
              ...
              bpd: function () {
                  ...
                  try {
                      ...
                      var n = bmak.gd();
                      var moz = window.DeviceOrientationEvent
                          ? 'do_en'
                          : 'do_dis';
                      var remainder = window.DeviceMotionEvent
                          ? 'dm_en'
                          : 'dm_dis';
                      ...
                      var S = bmak.sed();
                      var coordsOfTerritoriesToSplit =
                          bmak.mn_get_current_challenges();
                      ...
                      try {
                          ...
                          bmak.sd_debug(',s3:' + T);
                          bmak.sensor_data =
                              bmak.ver + bmak.sensor_data + ',s3:' + T;
                      }
                  }
                  try {
                      var m_key = bmak
                          .od(bmak.cs, bmak.api_public_key)
                          .slice(0, 16);
                      var m_buffer = Math.floor(bmak.get_cf_date() / 36e5);
                      var R = bmak.get_cf_date();
                      var $eol =
                          m_key + bmak.od(m_buffer, m_key) + bmak.sensor_data;
                      bmak.sensor_data =
                          $eol +
                          ';' +
              ...
              get_mn_params_from_abck: function () {
                  ...
                  try {
                      ...
                      if (false !== c_user) {
                          var tiledImageTLs =
                              decodeURIComponent(c_user).split('~');
              ...
              mn_poll: function () {
                  if (0 == bmak.mn_state) {
                      ...
                      var button2Component =
                          bmak.mn_get_new_challenge_params(button2);
              ...
              mn_w: function () {
                  try {
                      ...
                      for (; 0 == s; ) {
                          ...
                          if (
                              0 ==
                              bmak.bdm(specificResourceHandler, artistTrack)
                          ) {
                              /** @type {number} */
                              s = 1;
                              /** @type {number} */
                              ...
                              if (
                                  ...
                                  return (
                                      (bmak.mn_wt += t),
                                      void setTimeout(bmak.mn_w, bmak.mn_stout)
                                  );
                              }
                          }
                      }
              ...
              applyFunc: function () {
                  ...
                  if (bmak.listFunctions[indexLookupKey]) {
                      bmak.listFunctions[indexLookupKey].apply(
                          bmak.listFunctions,
                          batch
                      );
                  }
              ...
              getStateField: function (canCreateDiscussions) {
                  ...
                  for (; i < data.length; ) {
                      if (
                          keys.indexOf(data[i]) >= 0 ||
                          keys.indexOf(data[i + 1]) >= 0
                      ) {
